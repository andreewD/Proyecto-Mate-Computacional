...
points.append(np.matrix([-2,2,-1]))
points.append(np.matrix([2,2,-1]))
points.append(np.matrix([2,-2,-1]))
points.append(np.matrix([-2,-2,-1]))
points.append(np.matrix([-2,2,3]))
points.append(np.matrix([2,2,3]))
points.append(np.matrix([2,-2,3]))
points.append(np.matrix([-2,-2,3]))
...
while True:
    ...
    pygame.draw.line(screen, (  0,   0,   0), (500, 000), (500,1000), 2)
    pygame.draw.line(screen, (  0,   0,   0), (0, 1000), (1000,000), 2)
